...
dff = pd.read_excel(r"C:\Users\Lenovo\Downloads/ContactNo_17032023 (0 Arrears).xlsx")
...
#          .reset_index()
#          .rename(columns={'level_2':[0,15]}))
df1 = (meregdff.set_index(['propertycode',           'propertyname',
              'propertyaddress',               'msebDate',
                    'Zone_Type'])
         .stack()
         .reset_index()
